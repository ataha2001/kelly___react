...
const Resume = () => {
  ...
  const detailsResume = "Magnam dolores commodi suscipit. Necessitatibus eius consequatur ex aliquid fuga eum quidem. Sit sint consectetur velit. Quisquam quos quisquam cupiditate. Et nemo qui impedit suscipit alias ea. Quia fugiat sit in iste officiis commodi quidem hic quas."
  return (
    <div className="container d-flex align-items-center flex-column resume"  data-aos="fade-up">
      <div className="section-title">
        <Header title={titleResume} details={detailsResume} />
      </div>
      <div className='row'>
